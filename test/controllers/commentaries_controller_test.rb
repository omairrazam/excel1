...
class CommentariesControllerTest < ActionController::TestCase
  ...
  test "should create commentary" do
    assert_difference('Commentary.count') do
      post :create, commentary: { belongs_to: @commentary.belongs_to, body: @commentary.body, title: @commentary.title }
    end
  ...
  test "should update commentary" do
    patch :update, id: @commentary, commentary: { belongs_to: @commentary.belongs_to, body: @commentary.body, title: @commentary.title }
    assert_redirected_to commentary_path(assigns(:commentary))
  end
